 ...
 */
final class Techvertu_CustomWidgets {
	...
	public function __construct() {
		...
		wp_register_script( 'script-handle', TECHVERTU_ELEMENTOR_DIR.'js/scripts.js', [ 'elementor-frontend' ], '1.0.0', true );
		
	}

	public function get_script_depends() {
		return [ 'script-handle', 'google-script' ];
	}
	/**
	 * Load Textdomain
	 *
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-customwidget' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( TECHVERTU_ELEMENTOR_WIDGETS ) );
...
// Instantiate TBFLIM_ELEMENTOR_WIDGETS.
new Techvertu_CustomWidgets();
