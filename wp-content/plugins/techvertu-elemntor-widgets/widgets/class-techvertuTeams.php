 ...
 * @since 1.0.0
 */
class techvertuTeams extends Widget_Base
{

	public function get_name()
	{
		return 'techvertuTeams';
	}
	...
	{
		return __('Techvertu teams', 'elementor');
	}
	...
	protected function _register_controls()
	{
        ...
        $repeater->add_control(
			'role',
			[
				'label' => esc_html__('Role', 'plugin-name'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__('List Title', 'plugin-name'),
				'label_block' => true,
			]
        ...
        $repeater->add_control(
			'company',
			[
				'label' => esc_html__('Company', 'plugin-name'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__('List Title', 'plugin-name'),
				'label_block' => true,
			]
	...
	protected function render()
	{
		...
		?>
            <div class="techvertu-teams">
                <div class="swiper techvertu-swiper">
                    <div class="swiper-wrapper">
                        <?php foreach ($settings['list'] as $item) { ?>
                            <div class="swiper-slide">
                                <article class="team-item clearfix">
                                    <figure class="image-wrapper">
                                        <img src="<?php echo($item['image']['url']);?>" />
                                    </figure>
                                    <div class="team-item-content clearfix">
